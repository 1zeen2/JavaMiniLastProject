 ...
 * 									-------- 문자열을 제어하는 기능을 가지고 있다. (메서드)
 * 	String 사용법
 * 	String name = "글자 수 제한이 없는 문자열"; ==> char[]을 클래스화한 형태
 * 	----------------------------------------
 * 
 * 	----------------------- 데이터 형을 제어하는 클래스 : Wrapper
 * 	int			==> Integer
 *  long		==> Long
 *	byte		==> Byte
 *	double		==> Double
 ...
 *			= replaceAll();
 *			= split()
 *			= concat() ==> 문자열 결합에는 +가 있어 자주 사용하지는 않는다.
 *		제어
 *			= substring()
 *			= indexOf()
 *			= lastIndexOf();
...
public class 문자열배열 {
	...
	public static void main(String[] args) {
		...
		// 노래 출력
			 System.out.println("등록된 곡 총 " + title.length + "곡 수");
			 int rank = 1;
			 for (String t :title) {
