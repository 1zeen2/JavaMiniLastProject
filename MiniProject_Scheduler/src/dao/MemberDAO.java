...
public class MemberDAO {
	...
	// 1. 로그인처리
	/*
	 * 리턴형 => 경우의 수 = 사번이 없는 경우 0 = 사번은 존재 이름이 틀린경우 1 = 사번은 존재, 이름도 동일 2
	 * ------------------------------String / int
	 */
...
//	1-1 회원 정보 읽기
	...
	// 2-1 아이디 중복체크
	/*
	 * ID PW NAME SEX BIRTHDAY POST ADDR1 ADDR2 PHONE EMAIL CONTENT REGDATE ADMIN
	 */
	public String memberInsert(MemberVO vo) {
		/*
		 * Statement String sql = "INSERT INTO memver VALUES(
		 */
		String result = "";
		try {
			getConnection();
