...
public class Reservation extends JFrame implements ActionListener, MouseListener {
	...
	public Reservation() {
		...
		/*
		 * String [] col1 = {"12시","1시","2시","3시","4시","5시","6시","7시","8시","9시"}; String
		 * [][] row1 = new String [1][10]; timeModel = new DefaultTableModel(row1, col1)
		 * {
		 * 
		...
		String[][] timeData = { { "12:00", "Available" }, { "13:00", "Available" }, { "14:00", "Available" },
				{ "15:00", "Available" }, { "16:00", "Available" }, { "17:00", "Available" }, { "18:00", "Available" },
				{ "19:00", "Available" }, { "20:00", "Available" }, { "21:00", "Available" }
		...
		/*
		 * timeTable = new JTable(timeModel); timeTable.setGridColor(Color.DARK_GRAY);
		 * timeTable.setShowGrid(true); timeTable.setRowHeight(20);
		 * timeTable.setBounds(160, 670, 700, 70);
		 * 
		 * // 스크롤 팬을 사용하여 테이블 추가 JScrollPane scrollPane1 = new JScrollPane(timeTable);
		 * scrollPane1.setBounds(160, 670, 600, 35); add(scrollPane1);
		 */
