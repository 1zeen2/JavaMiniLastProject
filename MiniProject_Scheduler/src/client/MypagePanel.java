...
//		배치
		...
		/*
		 * b1 = new JButton(""); b1.setBounds(250, 620, 100, 30); add(b1);
		 */
	...
	public void print() {
		...
		for (CalendarVO vo : list) {
			Object[] data = { vo.getNo(), vo.getTitle(), vo.getPlace(), vo.getContent(), vo.getDay(), vo.getUserId() };
			model.addRow(data);
