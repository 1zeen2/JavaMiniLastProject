...
public class BoardInsertPanel extends JPanel implements ActionListener {
    JLabel titleLa,nameLa,subLa,contLa,pwdLa;
       ...
       public BoardInsertPanel(ControllPanel cp)
       {
          ...
          setLayout(null);
          titleLa.setBounds(90, 15, 900, 50);
          add(titleLa);
          
          nameLa=new JLabel("이름",JLabel.CENTER);
          nameTf=new JTextField();
          nameLa.setBounds(70, 100, 80, 30);
          nameTf.setBounds(155, 100, 150, 30);
          add(nameLa);add(nameTf);
          
          subLa=new JLabel("제목",JLabel.CENTER);
          subTf=new JTextField();
          subLa.setBounds(70, 135, 80, 30);
          subTf.setBounds(155, 135, 450, 30);
          add(subLa);add(subTf);
          ...
          contLa.setBounds(70, 170, 80, 30);
          js.setBounds(155, 175, 900, 450);
          add(contLa);add(js);
    
          pwdLa=new JLabel("비밀번호",JLabel.CENTER);
          pwdPf=new JPasswordField();
          //             Top  Right Bottom Left ==> CSS
          pwdLa.setBounds(70, 635, 80, 30);
          //             x  y width heigth
          pwdPf.setBounds(155, 635, 150, 30);
          add(pwdLa);add(pwdPf);
