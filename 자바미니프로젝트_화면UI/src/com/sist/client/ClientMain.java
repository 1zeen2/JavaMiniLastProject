...
//	public ChattingPanel2 ctp = new ChattingPanel2();
	...
	public ClientMain() {	
		...
		mp.setBounds(350, 30, 800, 50);	// 메뉴 카테고리 크기와 위치를 지정합니다.
		add(mp);	// 프레임에 메뉴 패널을 추가합니다.
		
		cp.setBounds(0, 100, 1150, 630);	// 색상이 출력되는 화면의 크기와 위치를 지정합니다.
		add(cp);	// 프레임에 컨트롤러 패널을 추가합니다.
		
//		ctp.setBounds(0, 100, 690, 580);
//		add(ctp);
...
//		add("Center", ctp);
		...
		// 윈도우 크기 설정
		setSize(1200, 800);		// 사용자 정의 ==> 윈도우 크기를 설정합니다.
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (mp.b1 == e.getSource()) {			// 메뉴 1번 버튼을 클릭한 경우
			...
			cp.card.show(cp, "CHAT");			// 채팅 화면을 보여줍니다.
