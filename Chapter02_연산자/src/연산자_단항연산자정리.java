 ...
 * 		= 한 개	(변수)						수정 / 삭제 / 읽기
 * 		-------------------					=> 제어문, 연산자
 * 		= 여러 개	(배열, 클래스)					=> 변수 / 제어문 / 연산자
 * 		-------------------					같은 기능 별 묶음
 * 		= RAM에 저장 (휘발성 메모리)					게시판, 댓글, 회원 가입, 예약, ..
 ...
 * 		2) 이항연산자
 * 			연산 대상이 2개인 경우
 * 			산술 연산자	=> 같은 데이터형 만들어 놓고 시작한다.	(같은 데이터형끼리만 연산 가능)
 * 			--------
 * 			+, -, *, /, %
 * 			=>	+
 * 				1) 일반 산술	(더하기)
...
public class 연산자_단항연산자정리 {
	...
	public static void main(String[] args) {
		...
		System.out.println("7" + 7 * 7);
		System.out.println("7" + (7 + 7));
		// 714 => 우선 순위는 변경이 가능 => () : 최우선 순위 연산자
		// byte, char => int 이하 데이터형 ===> 연산 결과 값은 int 
